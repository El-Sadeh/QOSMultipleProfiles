...
{
    try {
        ResolutionCommand *sample = new ResolutionCommand;    
        rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
    ...
    try {
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                ResolutionCommandPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
...
ResolutionCommandPlugin_copy_sample(
    ...
    const ResolutionCommand *src)
{
    return ResolutionCommandPluginSupport_copy_data(dst,src);
}
    ...
    const ResolutionCommand *sample)
{
    try{
        ...
        result = ResolutionCommandPlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTICdrEncapsulation_getNativeCdrEncapsulationId(), 
            RTI_TRUE, NULL);  
    ...
    unsigned int length)
{
    ...
    rti::topic::reset_sample(*sample);
    return ResolutionCommandPlugin_deserialize_sample( 
        NULL, sample,
        &stream, RTI_TRUE, RTI_TRUE, 
        NULL);
}
    ...
    void *endpoint_plugin_qos)
{
    try {
        RTIBool result;
        const char *METHOD_NAME = "ResolutionCommandPlugin_deserialize";
        if (drop_sample) {} /* To avoid warnings */

        stream->_xTypesState.unassignable = RTI_FALSE;
        result= ResolutionCommandPlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
...
RTIBool ResolutionCommandPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = ResolutionCommandPlugin_get_serialized_sample_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
RTIBool ResolutionCommandPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    ResolutionCommand *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool ResolutionCommandPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    ResolutionCommand **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= ResolutionCommandPlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = ResolutionCommandPlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *ResolutionCommandPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    ResolutionCommandPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    ResolutionCommandPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    ResolutionCommandPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    ResolutionCommandPlugin_return_sample;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    ResolutionCommandPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    ResolutionCommandPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ResolutionCommandPlugin_get_serialized_sample_size;

    static const char * TYPE_NAME = "ResolutionCommand";
    plugin->endpointTypeName = TYPE_NAME;
...
void
ResolutionCommandPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
